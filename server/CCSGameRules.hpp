...
namespace source2sdk::server
{
    ...
    public:
        ...
        entity2::GameTime_t m_flIntermissionStartTime; // 0xd5c        
        entity2::GameTime_t m_flIntermissionEndTime; // 0xd60        
        ...
        entity2::GameTime_t m_phaseChangeAnnouncementTime; // 0x122c        
        float m_fNextUpdateTeamClanNamesTime; // 0x1230        
        entity2::GameTime_t m_flLastThinkTime; // 0x1234        
        ...
        entity2::GameTime_t m_fTeamIntroPeriodEnd; // 0x17a8        
