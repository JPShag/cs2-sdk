...
namespace source2sdk::server
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0x5e1[0x13f]; // 0x5e1
        client::ChatIgnoreType_t m_iIgnoreGlobalChat; // 0x720        
        ...
        [[maybe_unused]] std::uint8_t pad_0x731[0xf]; // 0x731
        // metadata: MNetworkEnable
        ...
        [[maybe_unused]] std::uint8_t pad_0x74c[0x2c];
    ...
    static_assert(sizeof(CBasePlayerController) == 0x778);
};
